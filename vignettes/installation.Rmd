...
*PlasmoMAPI* relies on the [Rcpp](https://cran.r-project.org/web/packages/Rcpp/index.html) package, which requires the following OS-specific steps:
...
If you have any problems installing, please check the [Known issues](https://mrc-ide.github.io/PlasmoMAPI/articles/known-issues.html) page to see if there is a known solution. If not then please [raise an issue](https://github.com/mrc-ide/PlasmoMAPI/issues) on github.
